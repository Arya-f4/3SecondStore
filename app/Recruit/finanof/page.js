'use client'
import "./finan.css";
import Financial from "../SVG/Financialofficer.png";
...
<Image src={Financial} className="gambar"/>
</div>
  ...
  <div class="row">
    ...
    <div class="col-75">
      <select id="country" name="Job Hire">
        <option value="Development Team">Financial officer</option>
      </select>
    </div>
  </div>
  <div class="row">
